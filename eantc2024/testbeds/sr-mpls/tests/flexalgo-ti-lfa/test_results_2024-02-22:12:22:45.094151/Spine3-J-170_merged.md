...
Ethernet3      20.47.170.170/24     admin down    down           1500          
Ethernet43     20.32.170.170/24     admin down    down           1500          
Ethernet45     20.57.170.170/24     admin down    down           1500          
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    Spine3-J-170.00-00           98  64299  1152    113 L2  0100.0000.0170.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 852 s
      NLPID: 0xCC(IPv4)
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    LSPID                   Seq Num  Cksum  Life Length IS  Received LSPID        Flags
    Spine3-J-170.00-00           98  64299  1151    113 L2  0100.0000.0170.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 851 s
      NLPID: 0xCC(IPv4)
      Hostname: Spine3-J-170
      Area addresses: 49.0000
      Interface address: 10.0.0.170
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.0.0.170/32 [0 pref/0 metric] updated 20:44:40 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 20:44:39 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 20:44:39 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 20:44:39 ago
```
...
Ipv4:
  ...
  Adjacencies:  13  backlog:  0  unprogrammed:  0
Ipv6:
...
Jericho Ip Fecs:
  Non-ecmp fecs:  4101  ecmp fecs:  0  fec entries:  4101
Jericho Mpls Fecs:
...
Jericho Fec:
  ...
  Used:                     3   ecmp:                 1   reusedEcmp:  0     allocs:  3     frees:  0     shuffles:  0     cmds:  0   
...
Lpm Detail:
  Requests:  15  cleanses:  4  batches:  4  avg batch size:  3
...
Jericho Arp:
  ...
  IngressTable writes:  6690  queued      0   
