...
Uptime: 20 hours and 47 minutes
Total memory: 8099732 kB
Free memory: 5600576 kB
...
Et47      Arista_171   0:05      0.0   0.0%        0     53.2   0.5%        6
Et49/1    Nokia_57     0:05     53.3   0.5%        6      0.0   0.0%        0
```
...
IGP       default  NOKIA-SR2-57     L2   Ethernet49/1       P2P               UP    26          00                  
...
IS-IS Instance: IGP VRF: default
 ...
 U  juniper_379_MX304.00-00       146  25538   852    448 L2  0000.0001.7900.00-00  <>
    ...
    PE32-J2-172.00-00            26  63363   699    310 L2  0100.0000.0172.00-00  <>
      ...
      Time remaining until refresh: 399 s
      NLPID: 0xCC(IPv4)
...
Path constraints: algo MIN-IGP-ADMIN
                  metric type IGP
                  administrative-group exclude 127
Request sequence number: 85
Response sequence number: 85
...
Path constraints: algo MIN-TE
                  metric type TE
Request sequence number: 69
Response sequence number: 69
Number of times path updated: 69
Last updated: 0:01:43 ago
Next Hop Interface
-------- ---------
...
BGP neighbor is 10.0.0.211, remote AS 65000, internal link
  ...
  Failed connection attempts is 446
  Idle-restart timer is inactive
  BGP state is Active
  Number of transitions to established: 0
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Network is unreachable), Last time 00:02:25, First time 20:45:12, Repeats 445
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Connection refused), Last time 00:00:48, First time 00:03:39, Repeats 6
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 20:45:26 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 20:45:26 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 20:45:26 ago
```
...
Jericho2 Fec:
  ...
  ReusedEcmp:  0  allocs:  51  frees:  39  shuffles:  0  cmds:  0
  Zombies:     0    purges:    0
...
Lpm Detail:
  Requests:  290  cleanses:  100  batches:  100  avg batch size:  2

Jericho Arp:
  ArpTable writes:      16831  queued      0   
  IngressTable writes:  75024  queued      0   
