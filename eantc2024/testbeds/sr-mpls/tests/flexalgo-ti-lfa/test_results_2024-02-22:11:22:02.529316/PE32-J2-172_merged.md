...
IGP       default  PE31-J2-171      L2   Ethernet47         P2P               UP    21          54                  
```
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    h3c_19_CR16010E-F.00-00      1968   5604  1185    367 L2  0000.0000.0019.00-00  <>
      NLPID: 0xCC(IPv4)
    ...
    PE32-J2-172.00-00            22  65407  1037    310 L2  0100.0000.0172.00-00  <>
      ...
      Time remaining until refresh: 737 s
      NLPID: 0xCC(IPv4)
  ...
  IS-IS Level 2 Link State Database
    ...
    h49-N540-24Q8L2DD.00-01       101  23389   590    188 L2  0000.0000.0349.00-01  <>
      Router Capabilities: Router Id: 10.0.1.49 Flags: []
        ...
        Flex Algo: Algorithm: 141 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
        Flex Algo: Algorithm: 142 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
    h55-8201-24H8FH.00-00       420  48652   733    580 L2  0000.0000.0355.00-00  <>
      NLPID: 0xCC(IPv4)
      Hostname: h55-8201-24H8FH
    ...
    juniper_379_MX304.00-00       138  65081  1132    556 L2  0000.0001.7900.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.179 Flags: []
        ...
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 0
      Unsupported TLV: Type: 14 Length: 2
    0010.0010.0005.00-00        217  47877  1034    303 L2  0010.0010.0005.00-00  <>
      NLPID: 0xCC(IPv4)
      ...
      Router Capabilities: Router Id: 10.0.0.5 Flags: []
        ...
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SSPF (1) Prio: 128
        Flex Algo: Algorithm: 129 Metric: TE Metric (2) Calc: SSPF (1) Prio: 129
    NOKIA-SR2-57.00-00        17144  41549  1185    998 L2  0100.0000.0057.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: NOKIA-SR2-57
      ...
      Router Capabilities: Router Id: 10.0.0.57 Flags: []
        ...
        Flex Algo: Algorithm: 132 Metric: IGP Metric (0) Calc: SPF (0) Prio: 100
          Exclude admin groups: 255
          Flags: [M] 0x80
    PE31-J2-171.00-00           511  13517   984    378 L2  0100.0000.0171.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: PE31-J2-171
      Area addresses: 49.0000
...
Path constraints: algo MIN-TE
                  metric type TE
Request sequence number: 64
Response sequence number: 64
...
BGP neighbor is 10.0.0.211, remote AS 65000, internal link
  ...
  Last sent socket-error:Connect (Network is unreachable), Last time 00:01:50, First time 19:44:29, Repeats 424
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Hold timer is inactive
  Keepalive timer is inactive
  Connect timer is active, time left: 00:03:00
  Connection interval is 148 seconds
  ...
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Connection refused), Last time 00:00:10, First time 02:22:07, Repeats 57
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 19:44:42 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 19:44:42 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 19:44:42 ago
```
...
Jericho2 Lpm:
  ...
  Route buckets used:  10  Rows used:     2   Entries Per Bucket:  5  Percent free:  99
...
Lpm Detail:
  Requests:  210  cleanses:  72  batches:  72  avg batch size:  2

Jericho Arp:
  ArpTable writes:      16831  queued      0   
  IngressTable writes:  74868  queued      0   
