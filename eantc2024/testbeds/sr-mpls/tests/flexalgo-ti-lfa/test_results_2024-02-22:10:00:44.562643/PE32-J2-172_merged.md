...
Uptime: 18 hours and 24 minutes
Total memory: 8099732 kB
Free memory: 5597868 kB
...
IGP       default  NOKIA-SR2-57     L2   Ethernet49/1       P2P               UP    25          00                  
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    h3c_19_CR16010E-F.00-00      1916  32176  1144    367 L2  0000.0000.0019.00-00  <>
      NLPID: 0xCC(IPv4)
      ...
      Router Capabilities: Router Id: 10.0.0.19 Flags: []
        ...
        Flex Algo: Algorithm: 131 Metric: IGP Metric (0) Calc: SPF (0) Prio: 128
          ...
          Flags: [] 0x1
    eantc-jcnr2.00-00           648  32013   838    229 L2  0000.0000.0020.00-00  <>
    ...
    12502-1.00-00              7697  50534  1059    482 L2  0000.0000.0024.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.24 Flags: []
        ...
        Flex Algo: Algorithm: 131 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
          ...
          Flags: [] 0x1
    Ribbon-32.00-00             214   6889   345     83 L2  0000.0000.0032.00-00  <>
    ...
    h49-N540-24Q8L2DD.00-00       578  12656  1186    945 L2  0000.0000.0349.00-00  <>
      ...
      Reachability         : 20.149.254.0/24 Metric: 10 Type: 1 Up
      Unsupported TLV: Type: 14 Length: 2
    h49-N540-24Q8L2DD.00-01        95  26455   828    188 L2  0000.0000.0349.00-01  <>
  ...
  IS-IS Level 2 Link State Database
    ...
    eantc-jcnr2.00-00           648  32013   838    229 L2  0000.0000.0020.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.83 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    12502-1.00-00              7697  50534  1058    482 L2  0000.0000.0024.00-00  <>
      NLPID: 0xCC(IPv4)
      Hostname: 12502-1
    ...
    Ribbon-32.00-00             214   6889   345     83 L2  0000.0000.0032.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.32 Flags: []
        ...
        Algorithms:  0, 128
      Unsupported TLV: Type: 14 Length: 2
    Ribbon-32.00-03               1  37297   345     38 L2  0000.0000.0032.00-03  <>
      Remaining lifetime received: 1181 s Modified to: 1200 s
      Hostname: Ribbon-32
    Ribbon-32.00-04              40  58307   757    397 L2  0000.0000.0032.00-04  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
    ...
    h49-N540-24Q8L2DD.00-01        95  26455   827    188 L2  0000.0000.0349.00-01  <>
      Router Capabilities: Router Id: 10.0.1.49 Flags: []
        ...
        Flex Algo: Algorithm: 141 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
        Flex Algo: Algorithm: 142 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
    h55-8201-24H8FH.00-00       414  51718  1058    580 L2  0000.0000.0355.00-00  <>
      NLPID: 0xCC(IPv4)
      Hostname: h55-8201-24H8FH
      ...
      Router Capabilities: Router Id: 10.0.1.55 Flags: []
        ...
        Flex Algo: Algorithm: 142 Metric: IGP Metric (0) Calc: SPF (0) Prio: 10
      Unsupported TLV: Type: 14 Length: 2
    juniper_379_MX304.00-00       121  23532  1078    524 L2  0000.0001.7900.00-00  <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: juniper_379_MX304
...
BGP neighbor is 10.0.0.211, remote AS 65000, internal link
  ...
  Failed connection attempts is 396
  Idle-restart timer is inactive
  BGP state is Active
  Number of transitions to established: 0
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Network is unreachable), Last time 00:02:12, First time 18:23:08, Repeats 395
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Hold timer is inactive
  Keepalive timer is inactive
  Connect timer is active, time left: 00:01:43
  Connection interval is 148 seconds
  ...
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Connection refused), Last time 00:01:27, First time 01:00:45, Repeats 28
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 18:23:21 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 18:23:21 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 18:23:21 ago
```
...
Jericho2 Fec:
  ...
  ReusedEcmp:  0  allocs:  44  frees:  28  shuffles:  0  cmds:  0
  Zombies:     0    purges:    0
...
Lpm Detail:
  Requests:  186  cleanses:  50  batches:  50  avg batch size:  3

Jericho Arp:
  ArpTable writes:      16831  queued      0   
  IngressTable writes:  74795  queued      0   
...
|  -  |288384|ROUTE| Et47               |1010 |103421  | 2c:dd:e9:96:1a:b3 |   -   
