...
Uptime: 21 hours and 21 minutes
Total memory: 8099732 kB
Free memory: 5568404 kB
...
IGP       default  Ribbon-32        L2   Ethernet50/1       P2P               UP    77          00                  
IGP       default  NOKIA-SR2-57     L2   Ethernet49/1       P2P               UP    24          00                  
IGP       default  PE31-J2-171      L2   Ethernet47         P2P               UP    28          54                  
```
...
IS-IS Instance: IGP VRF: default
    ...
    huawei_254_NetEngine_8000_F8.00-00      8608  48181  1198    288 L2  0000.0000.0254.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.254 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0, 128
    h49-N540-24Q8L2DD.00-00       609  43190   800    858 L2  0000.0000.0349.00-00  <>
      NLPID: 0xCC(IPv4)
      ...
      Reachability         : 20.149.254.0/24 Metric: 10 Type: 1 Up
      Unsupported TLV: Type: 14 Length: 2
    h49-N540-24Q8L2DD.00-01       108  19812   631    188 L2  0000.0000.0349.00-01  <>
 ...
 U  0010.0010.0005.00-00        224   8691   772    346 L2  0010.0010.0005.00-00  <>
    ...
    NOKIA-SR2-57.00-00        17624   2506  1196    643 L2  0100.0000.0057.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
  ...
  IS-IS Level 2 Link State Database
    ...
    eantc-jcnr2.00-00           661  25370   495    229 L2  0000.0000.0020.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.83 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    12502-1.00-00              7747  24984   807    482 L2  0000.0000.0024.00-00  <>
      NLPID: 0xCC(IPv4)
      Hostname: 12502-1
    ...
    h49-N540-24Q8L2DD.00-01       108  19812   631    188 L2  0000.0000.0349.00-01  <>
      Router Capabilities: Router Id: 10.0.1.49 Flags: []
        ...
        Flex Algo: Algorithm: 141 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
        Flex Algo: Algorithm: 142 Metric: IGP Metric (0) Calc: SPF (0) Prio: 255
    h55-8201-24H8FH.00-00       429  64940   899    449 L2  0000.0000.0355.00-00  <>
      NLPID: 0xCC(IPv4)
      Hostname: h55-8201-24H8FH
      ...
      Router Capabilities: Router Id: 10.0.1.55 Flags: []
        ...
        Flex Algo: Algorithm: 142 Metric: IGP Metric (0) Calc: SPF (0) Prio: 10
      Unsupported TLV: Type: 14 Length: 2
    juniper_379_MX304.00-00       150   4385   379    350 L2  0000.0001.7900.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: juniper_379_MX304
      ...
      Router Capabilities: Router Id: 10.0.0.179 Flags: []
        ...
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 0
      Unsupported TLV: Type: 14 Length: 2
 U  0010.0010.0005.00-00        224   8691   771    346 L2  0010.0010.0005.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
    ...
    PE31-J2-171.00-00           527  44583   725    413 L2  0100.0000.0171.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.171 Flags: []
        ...
        Flex Algo: Algorithm: 129 Metric: TE Metric (2) Calc: SPF (0) Prio: 237
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 237
    PE32-J2-172.00-00            31  46864   936    372 L2  0100.0000.0172.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 636 s
      NLPID: 0xCC(IPv4)
      Hostname: PE32-J2-172
      Area addresses: 49.0000
      Interface address: 20.32.172.172
...
Path constraints: algo MIN-TE
                  metric type TE
Request sequence number: 111
Response sequence number: 111
Number of times path updated: 110
Last updated: 0:06:32 ago
Metric: 12
Next Hop     Interface   
------------ ------------
...
Path constraints: algo MIN-IGP-ADMIN
                  metric type IGP
                  administrative-group exclude 127
Request sequence number: 106
Response sequence number: 106
...
Request sequence number: 106
Response sequence number: 106
Number of times path updated: 105
Last updated: 0:06:32 ago
Metric: 10
Next Hop       Interface 
-------------- ----------
...
Number of times path updated: 92
Last updated: 0:06:32 ago
Next Hop Interface
-------- ---------
...
--------- ----------------- -------------------------- -------------- ---------
  ...
  9         10.0.0.171/32     TI-LFA (1)                 -            [ 3 ]    
  10        10.0.0.32/32      TI-LFA (2)                 -            [ 3 ]    
...
Via Type Codes:
 ...
 20032   A[1]
                via M, ::, pop
                  ...
                  via TI-LFA tunnel index 2
                    ...
                    backup via 20.171.172.171, Ethernet47, label 20032
 20057   A[1]
                via M, ::, forward
                    EgressACL: apply
                  via TI-LFA tunnel index 5
 ...
 20171   A[1]
                via M, ::, pop
                  ...
                  via TI-LFA tunnel index 1
                    ...
                    backup via 20.32.172.32, Ethernet50/1, label 20171
 20349   A[1]
                via M, ::, forward
                    EgressACL: apply
                  via TI-LFA tunnel index 5
 ...
 411298  A[1]
                via M, 20.32.172.32, pop
                    EgressACL: apply
                    directly connected, Ethernet50/1
                    30:c5:07:1f:33:10, vlan 1011
```
...
BGP neighbor is 10.0.0.211, remote AS 65000, internal link
  ...
  Failed connection attempts is 458
  Idle-restart timer is inactive
  BGP state is Active
  Number of transitions to established: 0
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Network is unreachable), Last time 00:02:13, First time 21:19:43, Repeats 457
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Connection refused), Last time 00:02:57, First time 00:38:10, Repeats 18
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 21:19:56 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 21:19:56 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 21:19:56 ago
```
...
Jericho2 Ip Fecs:
  Non-ecmp fecs:  4112  ecmp fecs:  1  fec entries:  4114
Jericho2 Mpls Fecs:
...
Jericho2 Fec:
  ...
  ReusedEcmp:  0  allocs:  65  frees:  47  shuffles:  0  cmds:  0
  Zombies:     0    purges:    0
...
Lpm Detail:
  Requests:  330  cleanses:  116  batches:  116  avg batch size:  2

Jericho Arp:
  ArpTable writes:      16844  queued      0   
  IngressTable writes:  75172  queued      0   
...
|0  |10.0.0.32/32      |ROUTE| Et50/1             |1011 |103423  | 30:c5:07:1f:33:10 |  -  |288374|   -   
...
|0  |20.32.149.0/24    |ROUTE| Et50/1             |1011 |103423  | 30:c5:07:1f:33:10 |  -  |288374|   -   
|0  |20.32.171.0/24    |ROUTE| Et50/1             |1011 |103423  | 30:c5:07:1f:33:10 |16385|288375|   -   
|0  |20.32.171.0/24    |ROUTE| Et47               |1010 |103421  | 2c:dd:e9:96:1a:b3 |16385|288376|   -   
...
|0  |20.32.211.0/24    |ROUTE| Et50/1             |1011 |103423  | 30:c5:07:1f:33:10 |  -  |288374|   -   
