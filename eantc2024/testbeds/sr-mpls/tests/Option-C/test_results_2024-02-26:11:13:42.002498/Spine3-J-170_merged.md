...
IGP       default  Ribbon-32        L2   Ethernet43         P2P               UP    87          00                  
IGP       default  Ericsson_47      L2   Ethernet3          P2P               UP    24          02                  
...
IGP       default  h3c_19_CR16010E-F-2 L2   Ethernet53/1       P2P               UP    21          01                  
IGP       default  h55-8201-24H8FH  L2   Ethernet51/1       P2P               UP    30          00                  
    ...
    Ericsson_47.00-00            34  21667   482    166 L2  0000.0000.0047.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.47 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    R6676-50.00-00               34  36607   509    145 L2  0000.0000.0050.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: R6676-50
      Area addresses: 49.0001
  ...
  IS-IS Level 2 Link State Database
    ...
    Ribbon-32.00-02              21   3433  1038    179 L2  0000.0000.0032.00-02  <>
      ...
      Reachability         : 10.0.0.32/32 Metric: 0 Type: 1 Up
        SR Prefix-SID: 32 Flags: [N] Algorithm: 0
      Reachability         : 20.32.170.0/24 Metric: 10 Type: 1 Up
    Ericsson_47.00-00            34  21667   481    166 L2  0000.0000.0047.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: Ericsson_47
    ...
    R6676-50.00-00               34  36607   509    145 L2  0000.0000.0050.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.50 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    h3c_27_S12500R-2L.00-00        46  42788   980    187 L2  0000.0001.0027.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: h3c_27_S12500R-2L
      Area addresses: 49.0001
    ...
    JNPR-312-ACX7100-48L.00-00        27  42614   808    178 L2  0000.0003.1200.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.212 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    h3c_19_CR16010E-F-2.00-00        31  11702  1176    295 L2  0001.0000.0019.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: h3c_19_CR16010E-F-2
    ...
    NOKIA-SR2-57.00-00           27   3208   780    271 L2  0100.0000.0057.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.57 Flags: []
        ...
        SR Capability: Flags: [I V]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    Nokia-59-IXRe2.00-00         28  38082  1035    271 L2  0100.0000.0059.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: Nokia-59-IXRe2
    ...
    Spine3-J-170.00-00           57  58298   984    537 L2  0100.0000.0170.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.170 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
    PE32-J2-172.00-00            22  10488   556    162 L2  0100.0000.0172.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: PE32-J2-172
      Area addresses: 49.0000
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 04:13:57 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 04:13:57 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 04:13:57 ago
```
