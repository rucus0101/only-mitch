...
Et5                         0:01     31.9   0.3%        3    110.7   1.1%
Et24      Cisco_Spine_349   0:01    110.7   1.1%       13     32.1   0.3%
...
IGP       default  h49-N540-24Q8L2DD L2   Ethernet24         P2P               UP    30          00                  
```
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    R6676-50.00-00               39  11183   357    145 L2  0000.0000.0050.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.50 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    huawei_254_NetEngine_8000_F8.00-00        26  48015  1186    156 L2  0000.0000.0254.00-00  <>
      NLPID: 0xCC(IPv4)
    ...
    h49-N540-24Q8L2DD.00-00        60  15348  1083   1343 L2  0000.0000.0349.00-00  <>
      ...
      Unsupported TLV: Type: 14 Length: 2
    h49-N540-24Q8L2DD.00-01        33   5379   490    219 L2  0000.0000.0349.00-01  <>
    ...
    h55-8201-24H8FH.00-00        34  32951   567    482 L2  0000.0000.0355.00-00  <>
      NLPID: 0xCC(IPv4)
    ...
    0010.0010.0005.00-00         28  48405   380    268 L2  0010.0010.0005.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.5 Flags: []
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    NOKIA-SR2-57.00-00          780  46767  1191    325 L2  0100.0000.0057.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
...
IS-IS Instance: IPV6 VRF: default
  IS-IS Level 2 Link State Database
    LSPID                   Seq Num  Cksum  Life Length IS  Received LSPID        Flags
    anet-PE31-J2-171.00-00        25  39831   802     75 L2  0100.0000.0171.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 502 s
      NLPID: 0x8E(IPv6)
...
Path constraints: algo MIN-TE
                  metric type TE
Request sequence number: 53
Response sequence number: 53
Number of times path updated: 51
Last updated: 0:01:57 ago
Next Hop Interface
-------- ---------
...
Request sequence number: 52
Response sequence number: 52
Number of times path updated: 50
Last updated: 0:01:57 ago
Next Hop Interface
-------- ---------
...
Number of times path updated: 46
Last updated: 0:01:57 ago
Metric: 12
Next Hop       Interface 
-------------- ----------
...
-------- --------------------- ------------------------ ------------- ---------
 ...
 13       100.0.1.111/32        20.149.171.149           Ethernet24   [ 20411 ]
 14       209.209.209.209/32    20.149.171.149           Ethernet24   [ 21999 ]
...
*  10.0.0.171/32              1471   21471 Node       R:0 N:1 P:0 E:0 V:0 L:0      PE31-J2-171     L2    unprotected MIN-IGP-ADMIN
   ...
   100.0.1.111/32              411   20411 Node       R:0 N:1 P:0 E:0 V:0 L:0      3800.0000.4111  L2    node        SPF         
   209.209.209.209/32         1999   21999 Prefix     R:0 N:0 P:0 E:0 V:0 L:0      h55-8201-24H8FH L2    node        SPF         
...
Gateway of last resort is not set
 ...
 B I      10.0.0.59/32 [200/0]
           via BGP LU Forwarding tunnel index 7196
 ...
 B I      10.0.0.212/32 [200/0]
           via BGP LU Forwarding tunnel index 7200
...
Gateway of last resort is not set
 ...
 B E      20.32.111.0/24 [200/0]
           via 10.0.0.32/32, BGP LU tunnel index 3308, label 756641
              via IS-IS SR tunnel index 3, label 20032
                 via ::, NextLevelFecId2493952.5, label 20172
 B E      20.47.111.0/24 [200/0]
           via 10.0.0.47/32, BGP LU tunnel index 3306, label 720896
              via IS-IS SR tunnel index 3, label 20047
                 via ::, NextLevelFecId2493952.5, label 20172
 B E      20.59.111.0/24 [200/0]
           via 10.0.0.59/32, BGP LU tunnel index 3305, label 1048568
              via IS-IS SR tunnel index 3, label 20059
                 via ::, NextLevelFecId2493952.5, label 20172
 C        20.111.171.0/24
           directly connected, Ethernet5.209
 B E      20.111.212.0/24 [200/0]
           via 10.0.0.212/32, BGP LU tunnel index 3307, label 17
              via IS-IS SR tunnel index 3, label 20212
                 via ::, NextLevelFecId2493952.5, label 20172
 ...
 20032   A[1]
                via M, ::, swap 20032
                  ...
                  via IS-IS SR tunnel index 3
                    via 20.149.171.149, Ethernet24, label 20172
 20047   A[1]
                via M, ::, swap 20047
                    EgressACL: bypass
                  via IS-IS SR tunnel index 3
...
Source Codes:
 ...
 BL    20032    [1], 10.0.0.32/32
                via IS-IS SR tunnel index 3, swap 20032
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20172
 BL    20047    [1], 10.0.0.47/32
                via IS-IS SR tunnel index 3, swap 20047
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20172
 ...
 BL    20059    [1], 10.0.0.59/32
                via IS-IS SR tunnel index 3, swap 20059
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20172
 ...
 BL    20212    [1], 10.0.0.212/32
                via IS-IS SR tunnel index 3, swap 20212
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20172
 ...
 * >  L   10.0.0.32/32           10.0.0.172            0       -          100     0       65001 i Or-ID: 10.0.0.32 C-LST: 2.2.2.2 
 * >  L   10.0.0.47/32           10.0.0.172            0       -          100     0       65001 i Or-ID: 10.0.0.47 C-LST: 2.2.2.2 
 * >  L   10.0.0.59/32           10.0.0.172            0       -          100     0       65001 i Or-ID: 10.0.0.59 C-LST: 2.2.2.2 
 * >  L   10.0.0.171/32          -                     -       -          -       0       i
 * >  L   10.0.0.212/32          10.0.0.172            0       -          100     0       65001 i Or-ID: 10.0.0.212 C-LST: 2.2.2.2 
```
...
BGP neighbor is 10.0.0.19, remote AS 65000, internal link
  ...
  Last read 01:58:37, last write 01:58:17
  ...
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 01:57:48, First time 01:58:15, Repeats 1
  Last rcvd notification:Cease/peer de-configured, Last time 02:37:49
  Last sent socket-error:Connect (Connection refused), Last time 02:37:08, First time 02:37:27, Repeats 4
...
BGP neighbor is 10.0.0.32, remote AS 65001, external link
  ...
  Last read 00:00:10, last write 00:00:38
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:38:38
  Number of transitions to established: 3
  Last state was OpenConfirm
  Last event was RecvKeepAlive
  Last sent notification:Hold Timer Expired Error/None, Last time 01:39:09
  Last sent socket-error:Connect (Network is unreachable), Last time 01:38:45, First time 03:19:06, Repeats 14
  Last rcvd socket-error:Connection reset by peer, Last time 01:38:40, First time 03:19:32, Repeats 1
  Types of communities advertised: standard extended large
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 2.6ms/1.4ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 4
    Slow-start Threshold (ssthresh): 3
    TCP Throughput: 15.54 Mbps
...
BGP neighbor is 10.0.0.47, remote AS 65001, external link
  ...
  Last sent notification:Hold Timer Expired Error/None, Last time 01:16:42, First time 01:37:21, Repeats 1
  Last sent socket-error:Connect (Network is unreachable), Last time 01:15:01, First time 01:37:20, Repeats 15
  Types of communities advertised: standard extended large
  Enhanced route refresh stale path removal disabled
  Outbound enhanced route refresh enabled
  Neighbor Capabilities:
...
TCP Socket Information:
  ...
  Send-Q: 0/46080
  Outgoing Maximum Segment Size (MSS): 1248
  Total Number of TCP retransmissions: 33
  Options:
    Timestamps enabled: yes
    Selective Acknowledgments enabled: yes
    Window Scale enabled: yes
  ...
  Socket Statistics:
    Window Scale (wscale): 0,7
    Retransmission Timeout (rto): 1356.0ms
    Round-trip Time (rtt/rtvar): 321.2ms/178.1ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 4
    Slow-start Threshold (ssthresh): 3
    TCP Throughput: 0.12 Mbps
...
BGP neighbor is 10.0.0.57, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group BGP-LU
  Last read 01:19:43, last write 01:19:28
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:00:27, First time 01:19:28, Repeats 158
  Last sent socket-error:Broken pipe, Last time 01:39:53, First time 02:39:55, Repeats 24
  Last rcvd socket-error:Connection reset by peer, Last time 01:41:11, First time 02:30:11, Repeats 3
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol IPv4 with MPLS Labels: advertised and received
...
BGP neighbor is 10.0.0.59, remote AS 65001, external link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 00:21:31
  Number of transitions to established: 2
  Last state was OpenConfirm
  Last event was RecvUpdate
  Last sent notification:Cease/connection rejected, Last time 00:21:33, First time 00:25:03, Repeats 7
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol VPN-IPv4: advertised and received and negotiated
  ...
  Configured maximum total number of routes is 256000, warning limit is 204800
  Inbound updates dropped by reason:
    AS path loop detection: 9
    Cluster ID loop detection: 0
    Enforced First AS: 0
    Malformed MPBGP routes: 38
    Originator ID matches local router ID: 0
    Nexthop matches local IP address: 0
    Unexpected IPv6 nexthop for IPv4 routes: 0
  Inbound updates with attribute errors:
...
Local AS is 65000, local router ID 10.0.0.171
TTL is 10, external peer can be 10 hops away
Local TCP address is 10.0.0.171, local port is 36013
...
BGP neighbor is 10.0.0.172, remote AS 65000, internal link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 00:03:59
  Number of transitions to established: 6
  Last state was OpenConfirm
  Last event was RecvUpdate
  Last sent notification:Cease/connection rejected, Last time 01:13:20, First time 02:01:52, Repeats 24
  Last rcvd notification:Cease/administrative reset, Last time 00:04:01, First time 02:17:32, Repeats 2
  Types of communities advertised: standard extended large
  Enhanced route refresh stale path removal disabled
  Outbound enhanced route refresh enabled
  Neighbor Capabilities:
...
TTL is 255
Local TCP address is 10.0.0.171, local port is 179
Remote TCP address is 10.0.0.172, remote port is 45669
Local next hop for next hop self:
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Retransmission Timeout (rto): 204.0ms
    Round-trip Time (rtt/rtvar): 3.8ms/6.0ms
    Delayed Ack Timeout (ato): 40.0ms
...
BGP neighbor is 10.0.0.179, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group BGP-LU
  Last read 01:11:00, last write 01:10:55
  Hold time is 90, keepalive interval is 30 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:02:11, First time 01:10:53, Repeats 42
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol IPv4 with MPLS Labels: advertised and received
...
BGP neighbor is 10.0.0.212, remote AS 65001, external link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:09:27
  Number of transitions to established: 3
  Last state was OpenConfirm
  Last event was RecvUpdate
  Last sent notification:Hold Timer Expired Error/None, Last time 01:09:28, First time 01:38:34, Repeats 1
  Last rcvd notification:Cease/connection rejected, Last time 02:31:23, First time 03:03:26, Repeats 18
  Last sent socket-error:Connect (Network is unreachable), Last time 01:38:11, First time 01:38:33, Repeats 5
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol VPN-IPv4: advertised and received and negotiated
...
Local AS is 65000, local router ID 10.0.0.171
TTL is 10, external peer can be 10 hops away
Local TCP address is 10.0.0.171, local port is 35397
...
TCP Socket Information:
  ...
  Socket Statistics:
    Window Scale (wscale): 0,7
    Retransmission Timeout (rto): 204.0ms
    Round-trip Time (rtt/rtvar): 1.9ms/0.5ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 2
    Slow-start Threshold (ssthresh): 2
    TCP Throughput: 10.70 Mbps
    Advertised Recv Window (rcv_space): 12480
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Last read 02:04:18, last write 02:03:42
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 02:00:53, First time 02:03:14, Repeats 7
  Last sent socket-error:Connect (Network is unreachable), Last time 05:28:20, First time 05:28:43, Repeats 5
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
  ...
  Inbound updates with attribute errors:
    ...
    Last update with error received at: 03:50:50
  Inbound paths dropped by reason:
    IPv4 unicast NLRIs dropped due to martian prefix: 0
    IPv6 unicast NLRIs dropped due to martian prefix: 0
    IPv4 labeled-unicast NLRIs dropped due to excessive labels: 0
...
BGP neighbor is 10.0.1.55, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group BGP-LU
  Last read 01:40:22, last write 01:39:56
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:00:00, First time 01:39:31, Repeats 267
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol IPv4 with MPLS Labels: advertised and received
...
BGP neighbor is 2002::59, remote AS 65000, internal link
  ...
  Last sent socket-error:Connect (Network is unreachable), Last time 02:32:03, First time 05:28:43, Repeats 70
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
BGP neighbor is 2002::304, remote AS 65000, internal link
  ...
  Last state was Active
  Last event was AdminShutdown
  Last sent socket-error:Connect (Network is unreachable), Last time 02:33:06, First time 05:28:43, Repeats 69
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
100.0.1.111/32     IS-IS SR IPv4  13         10                 115            
209.209.209.209/32 IS-IS SR IPv4  14         10                 115            
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>C    2002::171/128 [0 pref/0 metric] updated 05:29:05 ago
         via Loopback0, directly connected
VRF: default, Protocol: route-input
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       B - BGP, O - Ospf, O3 - Ospf3, I - Isis, R - Rip, VL - VRF Leak
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 05:29:04 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 05:29:04 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 05:29:04 ago
```
...
Ipv4:
  Routes:       92  backlog:  0  unprogrammed:  0
...
Jericho2 Fec:
  ...
  ReusedEcmp:  0  allocs:  9740  frees:  9715  shuffles:  0  cmds:  0
  Zombies:     0    purges:    0
...
Lpm Detail:
  Requests:  11769  cleanses:  4237  batches:  4237  avg batch size:  2

Jericho Arp:
  ArpTable writes:      74247   queued      0   
  IngressTable writes:  109803  queued      0   
...
|0  |10.0.0.32/32      |ROUTE| FEC 528492         |0    |2097151 | 00:00:00:00:00:00 |  -  |288378|M 20172 20032
|0  |10.0.0.47/32      |ROUTE| FEC 528492         |0    |2097141 | 00:00:00:00:00:00 |  -  |288366|M 20172 20047
...
|0  |10.0.0.59/32      |ROUTE| FEC 528492         |0    |2097149 | 00:00:00:00:00:00 |  -  |288360|M 20172 20059
...
|0  |10.0.0.212/32     |ROUTE| FEC 528492         |0    |2097137 | 00:00:00:00:00:00 |  -  |288372|M 20172 20212
...
|0  |100.0.1.111/32    |ROUTE| Et24               |1015 |103421  | c0:f8:7f:6a:4e:1c |  -  |528486|   -   
...
|0  |209.209.209.209/32|ROUTE| Et24               |1015 |103421  | c0:f8:7f:6a:4e:1c |  -  |528486|   -   
...
|2  |20.32.111.0/24    |ROUTE| FEC 528492         |0    |2097148 | 00:00:00:00:00:00 |  -  |288382|M 20172 20032 756641
|2  |20.47.111.0/24    |ROUTE| FEC 528492         |0    |2097139 | 00:00:00:00:00:00 |  -  |288370|M 20172 20047 720896
|2  |20.59.111.0/24    |ROUTE| FEC 528492         |0    |2097142 | 00:00:00:00:00:00 |  -  |288364|M 20172 20059 1048568
...
|2  |20.111.212.0/24   |ROUTE| FEC 528492         |0    |2097132 | 00:00:00:00:00:00 |  -  |288376|M 20172 20212 17
