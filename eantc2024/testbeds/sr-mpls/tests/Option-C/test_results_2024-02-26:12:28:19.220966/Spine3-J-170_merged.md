...
Et3       Ericson          0:05     73.9   0.8%       10     52.6   0.5%
Et43      RIBBON_32        0:05     77.4   0.8%       10     52.1   0.5%
Et49/2    Juniper_302      0:05    199.7   2.1%       33     52.4   0.5%
Et52/1    Arista_170       0:05    210.3   0.2%       31    426.3   0.4%
Et54/1    Nokia_59         0:05     77.4   0.8%       10     52.6   0.5%
Ma1                        0:05      0.1   0.0%        0     23.0   2.3%
...
IGP       default  Ericsson_47      L2   Ethernet3          P2P               UP    28          02                  
IGP       default  R6676-50         L2   Ethernet50/1       P2P               UP    28          02                  
IGP       default  juniper_379_MX304 L2   Ethernet49/1       P2P               UP    20          01                  
IGP       default  JNPR-312-ACX7100-48L L2   Ethernet49/2       P2P               UP    27          01                  
IGP       default  h3c_19_CR16010E-F-2 L2   Ethernet53/1       P2P               UP    25          01                  
IGP       default  h55-8201-24H8FH  L2   Ethernet51/1       P2P               UP    24          00                  
IGP       default  NOKIA-SR2-57     L2   Ethernet45         P2P               UP    21          00                  
IGP       default  Nokia-59-IXRe2   L2   Ethernet54/1       P2P               UP    23          00                  
IGP       default  PE32-J2-172      L2   Ethernet52/1       P2P               UP    27          65                  
```
  ...
  IS-IS Level 2 Link State Database
    ...
    h3c_19_CR16010E-F-2.00-00        37   8636   840    295 L2  0001.0000.0019.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.19 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
    h55-8201-24H8FH.00-00        31  50083   992    193 L2  0001.0000.0355.00-00  <>
      NLPID: 0xCC(IPv4)
    ...
    Spine3-J-170.00-00           63  55232  1150    537 L2  0100.0000.0170.00-00  <>
      ...
      Time remaining until refresh: 850 s
      NLPID: 0xCC(IPv4)
  ...
  IS-IS Level 2 Link State Database
    ...
    JNPR-312-ACX7100-48L.00-00        33  39548   607    178 L2  0000.0003.1200.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.212 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    h3c_19_CR16010E-F-2.00-00        37   8636   839    295 L2  0001.0000.0019.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: h3c_19_CR16010E-F-2
    ...
    Spine3-J-170.00-00           63  55232  1149    537 L2  0100.0000.0170.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 849 s
      NLPID: 0xCC(IPv4)
      Hostname: Spine3-J-170
      Area addresses: 49.0000
      Interface address: 20.32.170.170
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 05:28:37 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 05:28:37 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 05:28:37 ago
```
...
Lpm Detail:
  Requests:  105  cleanses:  35  batches:  35  avg batch size:  3
...
Jericho Arp:
  ...
  IngressTable writes:  7963  queued      0   
