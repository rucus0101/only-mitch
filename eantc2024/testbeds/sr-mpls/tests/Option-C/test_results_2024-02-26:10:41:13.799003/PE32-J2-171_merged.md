...
Et5                         0:01     42.7   0.4%        5    107.0   1.1%
Et24      Cisco_Spine_349   0:01    109.1   1.1%       13     43.8   0.4%
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    h3c_19_CR16010E-F.00-00        44  17396   770    275 L2  0000.0000.0019.00-00  <>
      NLPID: 0xCC(IPv4)
    ...
    huawei_254_NetEngine_8000_F8.00-00        18  52103   410    156 L2  0000.0000.0254.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.254 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
    h43-9901.00-00               23  44532  1089    186 L2  0000.0000.0343.00-00  <>
      NLPID: 0xCC(IPv4)
      Hostname: h43-9901
      Area addresses: 49
    ...
    h55-8201-24H8FH.00-00        26  35179  1036    461 L2  0000.0000.0355.00-00  <>
      ...
      Unsupported TLV: Type: 14 Length: 2
    juniper_379_MX304.00-00        33  14900   832    246 L2  0000.0001.7900.00-00  <>
    ...
    0010.0010.0005.00-00         21  51982   505    268 L2  0010.0010.0005.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.5 Flags: []
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    NOKIA-SR2-57.00-00          510  55960  1195    325 L2  0100.0000.0057.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.57 Flags: []
        ...
        SR Capability: Flags: [I V]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    PE31-J2-171.00-00            22  60636  1097    287 L2  0100.0000.0171.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 797 s
      NLPID: 0xCC(IPv4)
...
IS-IS Instance: IPV6 VRF: default
  IS-IS Level 2 Link State Database
    LSPID                   Seq Num  Cksum  Life Length IS  Received LSPID        Flags
    anet-PE31-J2-171.00-00        17  43919   942     75 L2  0100.0000.0171.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 642 s
      NLPID: 0x8E(IPv6)
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    PE31-J2-171.00-00            22  60636  1096    287 L2  0100.0000.0171.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 796 s
      NLPID: 0xCC(IPv4)
      Hostname: PE31-J2-171
      Area addresses: 49.0000
      Interface address: 20.149.171.171
...
Number of times path updated: 42
Last updated: 0:12:26 ago
Next Hop Interface
-------- ---------
...
Request sequence number: 43
Response sequence number: 43
Number of times path updated: 41
Last updated: 0:12:26 ago
Next Hop Interface
-------- ---------
...
Number of times path updated: 36
Last updated: 0:12:26 ago
Next Hop Interface
-------- ---------
...
Gateway of last resort is not set
 ...
 B I      10.0.0.59/32 [200/0]
           via BGP LU Forwarding tunnel index 3119
 ...
 B I      10.0.0.212/32 [200/0]
           via BGP LU Forwarding tunnel index 3094
...
Gateway of last resort is not set
 ...
 B E      20.32.111.0/24 [200/0]
           via 10.0.0.32/32, BGP LU tunnel index 1243, label 756641
              via IS-IS SR tunnel index 2, label 20032
                 via ::, NextLevelFecId2493952.5, label 20355
 B E      20.47.111.0/24 [200/0]
           via 10.0.0.47/32, BGP LU tunnel index 1236, label 720896
              via IS-IS SR tunnel index 2, label 20047
                 via ::, NextLevelFecId2493952.5, label 20355
 B E      20.59.111.0/24 [200/0]
           via 10.0.0.59/32, BGP LU tunnel index 1241, label 1048568
              via IS-IS SR tunnel index 2, label 20059
                 via ::, NextLevelFecId2493952.5, label 20355
 C        20.111.171.0/24
           directly connected, Ethernet5.209
 B E      20.111.212.0/24 [200/0]
           via 10.0.0.212/32, BGP LU tunnel index 1239, label 17
              via IS-IS SR tunnel index 2, label 20212
                 via ::, NextLevelFecId2493952.5, label 20355
 ...
 20005   A[1]
                via M, ::, swap 20005
                  ...
                  via IS-IS SR tunnel index 2
                    via 20.149.171.149, Ethernet24, label 20355
 20019   A[1]
                via M, forward
                    EgressACL: apply
                    20.149.171.149 Ethernet24
...
Source Codes:
 ...
 I>BL  20005    [1], 10.0.0.5/32
                via IS-IS SR tunnel index 2, swap 20005
 ...
 I>BL  20024    [1], 10.0.0.24/32
                via IS-IS SR tunnel index 2, swap 20024
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
 BL    20032    [1], 10.0.0.32/32
                via IS-IS SR tunnel index 2, swap 20032
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
 BL    20047    [1], 10.0.0.47/32
                via IS-IS SR tunnel index 2, swap 20047
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
 ...
 BL    20059    [1], 10.0.0.59/32
                via IS-IS SR tunnel index 2, swap 20059
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
 ...
 BL    20212    [1], 10.0.0.212/32
                via IS-IS SR tunnel index 2, swap 20212
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
 I>BL  20254    [1], 10.0.0.254/32
                via IS-IS SR tunnel index 2, swap 20254
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
 I>BL  20343    [1], 10.0.1.43/32
                via IS-IS SR tunnel index 2, swap 20343
                 payload autoDecide, ttlMode uniform, apply egress-acl
                    via 20.149.171.149, Ethernet24, label 20355
...
BGP neighbor is 10.0.0.19, remote AS 65000, internal link
  ...
  Last read 00:11:38, last write 00:11:18
  ...
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:10:49, First time 00:11:16, Repeats 1
  Last rcvd notification:Cease/peer de-configured, Last time 00:50:50
  Last sent socket-error:Connect (Connection refused), Last time 00:50:09, First time 00:50:28, Repeats 4
...
BGP neighbor is 10.0.0.32, remote AS 65001, external link
  ...
  Last read 00:00:16, last write 00:00:39
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:26:04
  Number of transitions to established: 2
  Last state was OpenConfirm
  Last event was RecvKeepAlive
  Last sent notification:Cease/connection rejected, Last time 02:14:25, First time 02:16:55, Repeats 9
  Last sent socket-error:Connect (Network is unreachable), Last time 01:26:09, First time 01:32:07, Repeats 8
  Last rcvd socket-error:Connection reset by peer, Last time 01:32:33
  Types of communities advertised: standard extended large
...
Local TCP address is 10.0.0.171, local port is 35415
...
BGP neighbor is 10.0.0.47, remote AS 65001, external link
  ...
  Inherits configuration from and member of peer-group OPTION-C-VPN
  Last read 00:00:21, last write 00:00:36
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 02:05:52
...
Local AS is 65000, local router ID 10.0.0.171
TTL is 10, external peer can be 10 hops away
Local TCP address is 10.0.0.171, local port is 40711
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Retransmission Timeout (rto): 420.0ms
    Round-trip Time (rtt/rtvar): 219.8ms/22.0ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 4
    Slow-start Threshold (ssthresh): 4
    TCP Throughput: 0.18 Mbps
    Advertised Recv Window (rcv_space): 12480

BGP neighbor is 10.0.0.57, remote AS 65000, internal link
  BGP version 4, remote router ID 0.0.0.0, VRF default
  Inherits configuration from and member of peer-group BGP-LU
  Last read never, last write 00:12:01
  ...
  Last sent socket-error:Broken pipe, Last time 00:12:01, First time 00:52:56, Repeats 18
  Last rcvd socket-error:Connection reset by peer, Last time 00:26:20, First time 00:43:12, Repeats 2
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
...
BGP neighbor is 10.0.0.59, remote AS 65001, external link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 00:25:32
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was RecvUpdate
  Last rcvd socket-error:Connection reset by peer, Last time 00:27:48, First time 00:42:58, Repeats 12
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol VPN-IPv4: advertised and received and negotiated
  ...
  Configured maximum total number of routes is 256000, warning limit is 204800
  Inbound updates dropped by reason:
    AS path loop detection: 19
    Cluster ID loop detection: 0
    Enforced First AS: 0
    Malformed MPBGP routes: 35
    Originator ID matches local router ID: 0
    Nexthop matches local IP address: 0
    Unexpected IPv6 nexthop for IPv4 routes: 0
  Inbound updates with attribute errors:
...
Remote TCP address is 10.0.0.59, remote port is 50384
Local next hop for next hop self:
  VPN-IPv4: 10.0.0.171
TCP Socket Information:
  TCP state is ESTABLISHED
...
BGP neighbor is 10.0.0.172, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group BGP-LU
  Last read 00:14:58, last write 00:14:55
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:00:11, First time 00:14:54, Repeats 12
  Last rcvd notification:Cease/administrative reset, Last time 00:30:33
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised and received
    Multiprotocol IPv4 with MPLS Labels: advertised and received
...
BGP neighbor is 10.0.0.179, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group BGP-LU
  Last read 00:11:15, last write 00:11:06
  Hold time is 90, keepalive interval is 30 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:01:02, First time 00:10:56, Repeats 18
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol IPv4 with MPLS Labels: advertised and received
...
BGP neighbor is 10.0.0.212, remote AS 65001, external link
  ...
  Inherits configuration from and member of peer-group OPTION-C-VPN
  Last read 00:00:28, last write 00:00:15
  Hold time is 90, keepalive interval is 30 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 00:42:56
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was RecvUpdate
  Last rcvd notification:Cease/connection rejected, Last time 00:44:24, First time 01:16:27, Repeats 18
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
    Multiprotocol VPN-IPv4: advertised and received and negotiated
...
TTL is 10, external peer can be 10 hops away
Local TCP address is 10.0.0.171, local port is 179
Remote TCP address is 10.0.0.212, remote port is 33336
Local next hop for next hop self:
  VPN-IPv4: 10.0.0.171
TCP Socket Information:
  TCP state is ESTABLISHED
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Last read 00:17:19, last write 00:16:43
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Last state was Established
  Last event was Open
  Last sent notification:Cease/connection rejected, Last time 00:13:54, First time 00:16:15, Repeats 7
  Last sent socket-error:Connect (Network is unreachable), Last time 03:41:21, First time 03:41:44, Repeats 5
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
    Multiprotocol IPv4 Unicast: advertised
  ...
  Inbound updates with attribute errors:
    ...
    Last update with error received at: 02:03:51
  Inbound paths dropped by reason:
    IPv4 unicast NLRIs dropped due to martian prefix: 0
    IPv6 unicast NLRIs dropped due to martian prefix: 0
    IPv4 labeled-unicast NLRIs dropped due to excessive labels: 0
...
BGP neighbor is 10.0.1.55, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group BGP-LU
  Last read 00:00:56, last write 00:00:41
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:48:28
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was RecvKeepAlive
  Types of communities advertised: standard extended large
  ...
  Message Statistics:
    ...
    Keepalives:           129       104
    Route Refresh:          0         0
    Total messages:       131       166
  Prefix Statistics:
                                   Sent      Rcvd     Best Paths     Best ECMP Paths
    IPv4 Unicast:                     0         0              0                   0
    IPv4 with MPLS Labels:            1         8              8                   0
    IPv6 Unicast:                     0         0              0                   0
  Configured maximum total number of routes is 256000, warning limit is 204800
  Inbound updates dropped by reason:
    AS path loop detection: 0
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 183.7ms/14.1ms
    Delayed Ack Timeout (ato): 40.0ms
...
BGP neighbor is 2002::59, remote AS 65000, internal link
  ...
  Last state was Active
  Last event was AdminShutdown
  Last sent socket-error:Connect (Network is unreachable), Last time 00:45:04, First time 03:41:44, Repeats 70
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
BGP neighbor is 2002::304, remote AS 65000, internal link
  ...
  Last state was Active
  Last event was AdminShutdown
  Last sent socket-error:Connect (Network is unreachable), Last time 00:46:07, First time 03:41:44, Repeats 69
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>C    2002::171/128 [0 pref/0 metric] updated 03:42:07 ago
         via Loopback0, directly connected
VRF: default, Protocol: route-input
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       B - BGP, O - Ospf, O3 - Ospf3, I - Isis, R - Rip, VL - VRF Leak
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 03:42:06 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 03:42:06 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 03:42:06 ago
```
...
Ipv4:
  ...
  Adjacencies:  72  backlog:  0  unprogrammed:  0
Ipv6:
...
Jericho2 Ip Fecs:
  Non-ecmp fecs:  4116  ecmp fecs:  2  fec entries:  4118
Jericho2 Mpls Fecs:
...
Jericho2 Lpm:
  ...
  Route buckets used:  15  Rows used:     4   Entries Per Bucket:  6  Percent free:  99
...
Jericho2 Fec:
  ...
  ReusedEcmp:  0  allocs:  3776  frees:  3747  shuffles:  0  cmds:  0
  Zombies:     0    purges:    0
...
Lpm Detail:
  Requests:  3931  cleanses:  1740  batches:  1740  avg batch size:  2

Jericho Arp:
  ArpTable writes:      40961  queued      0   
  IngressTable writes:  88779  queued      0   
