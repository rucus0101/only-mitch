...
Et3       Ericson          0:05     73.9   0.8%       10     52.4   0.5%
Et43      RIBBON_32        0:05     77.4   0.8%       10     52.2   0.5%
Et49/1    Juniper_379      0:05    281.6   2.9%       40    426.4   4.4%
Et49/2    Juniper_302      0:05    199.8   2.1%       34    123.9   1.3%
Et54/1    Nokia_59         0:05     77.4   0.8%       10     52.4   0.5%
Ma1                        0:05      0.1   0.0%        0     31.3   3.2%
...
IGP       default  Ribbon-32        L2   Ethernet43         P2P               UP    72          00                  
IGP       default  Ericsson_47      L2   Ethernet3          P2P               UP    29          02                  
IGP       default  R6676-50         L2   Ethernet50/1       P2P               UP    23          02                  
IGP       default  juniper_379_MX304 L2   Ethernet49/1       P2P               UP    23          01                  
IGP       default  JNPR-312-ACX7100-48L L2   Ethernet49/2       P2P               UP    27          01                  
IGP       default  h3c_19_CR16010E-F-2 L2   Ethernet53/1       P2P               UP    26          01                  
IGP       default  h55-8201-24H8FH  L2   Ethernet51/1       P2P               UP    23          00                  
IGP       default  NOKIA-SR2-57     L2   Ethernet45         P2P               UP    23          00                  
IGP       default  Nokia-59-IXRe2   L2   Ethernet54/1       P2P               UP    25          00                  
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    Spine3-J-170.00-00           57  58298   836    537 L2  0100.0000.0170.00-00  <>
      ...
      Time remaining until refresh: 536 s
      NLPID: 0xCC(IPv4)
  ...
  IS-IS Level 2 Link State Database
    ...
    Ribbon-32.00-00              17  16419   936     79 L2  0000.0000.0032.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.32 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
      Unsupported TLV: Type: 14 Length: 2
    Ribbon-32.00-01              17  32183  1154     38 L2  0000.0000.0032.00-01  <>
      Hostname: Ribbon-32
    Ribbon-32.00-02              21   3433   889    179 L2  0000.0000.0032.00-02  <>
      Interface address: 10.0.0.32
      Interface address: 20.32.170.32
      IS Neighbor          : Spine3-J-170.00     Metric: 10
        IPv4 Neighbor Address: 20.32.170.170
      ...
      Reachability         : 10.0.0.32/32 Metric: 0 Type: 1 Up
        SR Prefix-SID: 32 Flags: [N] Algorithm: 0
      Reachability         : 20.32.170.0/24 Metric: 10 Type: 1 Up
    Ericsson_47.00-00            34  21667   333    166 L2  0000.0000.0047.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: Ericsson_47
    ...
    h3c_27_S12500R-2L.00-00        46  42788   832    187 L2  0000.0001.0027.00-00  <>
      ...
      Router Capabilities: Router Id: 100.0.1.27 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
    juniper_379_MX304.00-00        30  33032   389    211 L2  0000.0001.7900.00-00  <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: juniper_379_MX304
    ...
    Nokia-59-IXRe2.00-00         28  38082   887    271 L2  0100.0000.0059.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.59 Flags: []
        ...
        SR Capability: Flags: [I V]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    Spine3-J-170.00-00           57  58298   835    537 L2  0100.0000.0170.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 535 s
      NLPID: 0xCC(IPv4)
      Hostname: Spine3-J-170
      Area addresses: 49.0000
      Interface address: 20.32.170.170
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 04:16:33 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 04:16:33 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 04:16:33 ago
```
