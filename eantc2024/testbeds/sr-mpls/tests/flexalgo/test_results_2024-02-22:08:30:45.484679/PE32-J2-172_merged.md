...
BGP neighbor is 10.0.0.211, remote AS 65000, internal link
  ...
  Failed connection attempts is 365
  Idle-restart timer is inactive
  BGP state is Active
  Number of transitions to established: 0
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Network is unreachable), Last time 00:00:59, First time 16:53:40, Repeats 364
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.0.0.172/32 [0 pref/0 metric] updated 16:53:57 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 16:53:55 ago
         via Null0, directly connected [NF]
>P    127.0.0.0/8 [1 pref/0 metric] updated 16:53:55 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 16:53:56 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 16:53:56 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 16:53:56 ago
```
...
Jericho2 Lpm:
  ...
  Route buckets used:  4  Rows used:     1   Entries Per Bucket:  3  Percent free:  99
...
Jericho2 Fec:
  ...
  ReusedEcmp:  0  allocs:  4  frees:  1  shuffles:  0  cmds:  0
  Zombies:     0    purges:    0
...
Lpm Detail:
  Requests:  19  cleanses:  6  batches:  6  avg batch size:  3

Jericho Arp:
  ArpTable writes:      16816  queued      0   
  IngressTable writes:  74240  queued      0   
