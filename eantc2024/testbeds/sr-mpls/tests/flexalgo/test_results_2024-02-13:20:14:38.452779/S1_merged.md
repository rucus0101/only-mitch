...
Et2       Uplink to Leaf #2  0:05    186.8   2.5%      364      0.0   0.0%
Et3       Uplink to Leaf #3  0:05      0.0   0.0%        0      0.1   0.0%
Et4       Uplink to Leaf #4  0:05      0.3   0.0%        0      0.0   0.0%
...
BGP neighbor is 10.1.1.1, remote AS 65101, external link
  ...
  Last read 00:00:30, last write 00:00:53
  ...
  BGP state is Established, up for 01:04:42
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 16.7ms/10.6ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 43.77 Mbps
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 9.3ms/1.2ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 78.42 Mbps
    Advertised Recv Window (rcv_space): 56362
...
BGP neighbor is 10.1.1.9, remote AS 65301, external link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:04:38
  Number of transitions to established: 1
  Last state was OpenConfirm
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 7.8ms/2.0ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 94.16 Mbps
    Advertised Recv Window (rcv_space): 56362
...
BGP neighbor is 10.1.1.11, remote AS 65301, external link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:04:40
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was Established
  Types of communities advertised: standard extended
...
TCP Socket Information:
  ...
  Socket Statistics:
    Window Scale (wscale): 7,7
    Retransmission Timeout (rto): 212.0ms
    Round-trip Time (rtt/rtvar): 8.9ms/1.7ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 82.03 Mbps
    Advertised Recv Window (rcv_space): 56362
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.1.1.0/31 [0 pref/0 metric] updated 01:04:45 ago
         via Ethernet1, directly connected
>C    10.1.1.2/31 [0 pref/0 metric] updated 01:04:45 ago
         via Ethernet2, directly connected
>C    10.1.1.4/31 [0 pref/0 metric] updated 01:04:45 ago
         via Ethernet3, directly connected
>C    10.1.1.6/31 [0 pref/0 metric] updated 01:04:45 ago
...
>C    10.1.1.12/31 [0 pref/0 metric] updated 01:04:41 ago
         via Ethernet9, directly connected
>C    10.1.1.14/31 [0 pref/0 metric] updated 01:04:40 ago
         via Ethernet10, directly connected
>C    10.255.255.1/32 [0 pref/0 metric] updated 01:06:29 ago
         via Loopback0, directly connected
>C    223.255.255.255/32 [0 pref/0 metric] updated 01:06:29 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>B    10.10.10.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.1 [0 pref/0 metric] type ipv4
            via 10.1.1.1, Ethernet1
         via 10.1.1.3 [0 pref/0 metric] type ipv4
            via 10.1.1.3, Ethernet2
>B    10.10.11.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.5 [0 pref/0 metric] type ipv4
            via 10.1.1.5, Ethernet3
         via 10.1.1.7 [0 pref/0 metric] type ipv4
            via 10.1.1.7, Ethernet4
>B    10.10.12.0/24 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.11 [0 pref/0 metric] type ipv4
            via 10.1.1.11, Ethernet8
         via 10.1.1.9 [0 pref/0 metric] type ipv4
            via 10.1.1.9, Ethernet7
>B    10.10.13.0/24 [200 pref/0 MED] updated 01:04:39 ago
         via 10.1.1.13 [0 pref/0 metric] type ipv4
            via 10.1.1.13, Ethernet9
         via 10.1.1.15 [0 pref/0 metric] type ipv4
            via 10.1.1.15, Ethernet10
>B    10.20.20.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.1 [0 pref/0 metric] type ipv4
            via 10.1.1.1, Ethernet1
         via 10.1.1.3 [0 pref/0 metric] type ipv4
            via 10.1.1.3, Ethernet2
>B    10.20.21.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.5 [0 pref/0 metric] type ipv4
            via 10.1.1.5, Ethernet3
         via 10.1.1.7 [0 pref/0 metric] type ipv4
            via 10.1.1.7, Ethernet4
>B    10.20.22.0/24 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.11 [0 pref/0 metric] type ipv4
            via 10.1.1.11, Ethernet8
         via 10.1.1.9 [0 pref/0 metric] type ipv4
            via 10.1.1.9, Ethernet7
>B    10.20.23.0/24 [200 pref/0 MED] updated 01:04:39 ago
         via 10.1.1.13 [0 pref/0 metric] type ipv4
            via 10.1.1.13, Ethernet9
         via 10.1.1.15 [0 pref/0 metric] type ipv4
            via 10.1.1.15, Ethernet10
>B    10.30.30.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.1 [0 pref/0 metric] type ipv4
            via 10.1.1.1, Ethernet1
         via 10.1.1.3 [0 pref/0 metric] type ipv4
            via 10.1.1.3, Ethernet2
>B    10.30.31.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.5 [0 pref/0 metric] type ipv4
            via 10.1.1.5, Ethernet3
         via 10.1.1.7 [0 pref/0 metric] type ipv4
            via 10.1.1.7, Ethernet4
>B    10.30.32.0/24 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.11 [0 pref/0 metric] type ipv4
            via 10.1.1.11, Ethernet8
         via 10.1.1.9 [0 pref/0 metric] type ipv4
            via 10.1.1.9, Ethernet7
>B    10.30.33.0/24 [200 pref/0 MED] updated 01:04:39 ago
         via 10.1.1.13 [0 pref/0 metric] type ipv4
            via 10.1.1.13, Ethernet9
         via 10.1.1.15 [0 pref/0 metric] type ipv4
            via 10.1.1.15, Ethernet10
>B    10.40.40.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.1 [0 pref/0 metric] type ipv4
            via 10.1.1.1, Ethernet1
         via 10.1.1.3 [0 pref/0 metric] type ipv4
            via 10.1.1.3, Ethernet2
>B    10.40.41.0/24 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.5 [0 pref/0 metric] type ipv4
            via 10.1.1.5, Ethernet3
         via 10.1.1.7 [0 pref/0 metric] type ipv4
            via 10.1.1.7, Ethernet4
>B    10.40.42.0/24 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.11 [0 pref/0 metric] type ipv4
            via 10.1.1.11, Ethernet8
         via 10.1.1.9 [0 pref/0 metric] type ipv4
            via 10.1.1.9, Ethernet7
>B    10.40.43.0/24 [200 pref/0 MED] updated 01:04:39 ago
         via 10.1.1.13 [0 pref/0 metric] type ipv4
            via 10.1.1.13, Ethernet9
         via 10.1.1.15 [0 pref/0 metric] type ipv4
            via 10.1.1.15, Ethernet10
>B    10.255.1.1/32 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.1 [0 pref/0 metric] type ipv4
            via 10.1.1.1, Ethernet1
         via 10.1.1.3 [0 pref/0 metric] type ipv4
            via 10.1.1.3, Ethernet2
>B    10.255.1.2/32 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.1 [0 pref/0 metric] type ipv4
            via 10.1.1.1, Ethernet1
         via 10.1.1.3 [0 pref/0 metric] type ipv4
            via 10.1.1.3, Ethernet2
>B    10.255.2.1/32 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.5 [0 pref/0 metric] type ipv4
            via 10.1.1.5, Ethernet3
         via 10.1.1.7 [0 pref/0 metric] type ipv4
            via 10.1.1.7, Ethernet4
>B    10.255.2.2/32 [200 pref/0 MED] updated 01:04:44 ago
         via 10.1.1.5 [0 pref/0 metric] type ipv4
            via 10.1.1.5, Ethernet3
         via 10.1.1.7 [0 pref/0 metric] type ipv4
            via 10.1.1.7, Ethernet4
>B    10.255.3.1/32 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.11 [0 pref/0 metric] type ipv4
            via 10.1.1.11, Ethernet8
         via 10.1.1.9 [0 pref/0 metric] type ipv4
            via 10.1.1.9, Ethernet7
>B    10.255.3.2/32 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.11 [0 pref/0 metric] type ipv4
            via 10.1.1.11, Ethernet8
         via 10.1.1.9 [0 pref/0 metric] type ipv4
            via 10.1.1.9, Ethernet7
>B    10.255.4.1/32 [200 pref/0 MED] updated 01:04:39 ago
         via 10.1.1.13 [0 pref/0 metric] type ipv4
            via 10.1.1.13, Ethernet9
         via 10.1.1.15 [0 pref/0 metric] type ipv4
            via 10.1.1.15, Ethernet10
>B    10.255.4.2/32 [200 pref/0 MED] updated 01:04:39 ago
         via 10.1.1.13 [0 pref/0 metric] type ipv4
            via 10.1.1.13, Ethernet9
         via 10.1.1.15 [0 pref/0 metric] type ipv4
            via 10.1.1.15, Ethernet10
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 01:06:26 ago
         via Null0, directly connected [NF]
>P    127.0.0.0/8 [1 pref/0 metric] updated 01:06:26 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 01:06:26 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 01:06:26 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 01:06:26 ago
```
