...
BGP neighbor is 1.1.1.2, remote AS 65301, internal link
  ...
  Last read 00:00:29, last write 00:00:02
  ...
  BGP state is Established, up for 01:04:49
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was Established
  Last sent socket-error:Connect (Network is unreachable), Last time 01:06:07, First time 01:06:32, Repeats 5
...
TTL is 255
Local TCP address is 1.1.1.1, local port is 179
Remote TCP address is 1.1.1.2, remote port is 52000
...
BGP neighbor is 10.1.1.8, remote AS 65001, external link
  ...
  Last read 00:00:22, last write 00:00:27
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
...
Local AS is 65301, local router ID 10.255.3.1
TTL is 1
Local TCP address is 10.1.1.9, local port is 39457
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 9.8ms/2.0ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 74.94 Mbps
...
BGP neighbor is 10.2.2.8, remote AS 65001, external link
  ...
  Inherits configuration from and member of peer-group SPINES
  Last read 00:00:01, last write 00:00:27
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
...
Local AS is 65301, local router ID 10.255.3.1
TTL is 1
Local TCP address is 10.2.2.9, local port is 35237
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    1.1.1.0/30 [0 pref/0 metric] updated 01:04:52 ago
         via Vlan4094, directly connected
>C    10.1.1.8/31 [0 pref/0 metric] updated 01:04:40 ago
         via Ethernet1, directly connected
>C    10.2.2.8/31 [0 pref/0 metric] updated 01:04:35 ago
         via Ethernet2, directly connected
>C    10.10.12.0/24 [0 pref/0 metric] updated 01:04:50 ago
         via Vlan10, directly connected
>C    10.20.22.0/24 [0 pref/0 metric] updated 01:04:50 ago
         via Vlan20, directly connected
>C    10.30.32.0/24 [0 pref/0 metric] updated 01:04:50 ago
         via Vlan30, directly connected
>C    10.40.42.0/24 [0 pref/0 metric] updated 01:04:50 ago
         via Vlan40, directly connected
>C    10.255.3.1/32 [0 pref/0 metric] updated 01:06:56 ago
         via Loopback0, directly connected
>C    223.255.255.255/32 [0 pref/0 metric] updated 01:06:56 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>B    10.10.10.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.10.11.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
 B    10.10.12.0/24 [200 pref/0 MED] updated 01:04:49 ago
         via 1.1.1.2 [0 pref/0 metric] type ipv4
            via 1.1.1.2, Vlan4094
>B    10.10.13.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.20.20.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.20.21.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
 B    10.20.22.0/24 [200 pref/0 MED] updated 01:04:49 ago
         via 1.1.1.2 [0 pref/0 metric] type ipv4
            via 1.1.1.2, Vlan4094
>B    10.20.23.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.30.30.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.30.31.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
 B    10.30.32.0/24 [200 pref/0 MED] updated 01:04:49 ago
         via 1.1.1.2 [0 pref/0 metric] type ipv4
            via 1.1.1.2, Vlan4094
>B    10.30.33.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.40.40.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.40.41.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
 B    10.40.42.0/24 [200 pref/0 MED] updated 01:04:49 ago
         via 1.1.1.2 [0 pref/0 metric] type ipv4
            via 1.1.1.2, Vlan4094
>B    10.40.43.0/24 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.1.1/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.1.2/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.2.1/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.2.2/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.3.2/32 [200 pref/0 MED] updated 01:04:51 ago
         via 1.1.1.2 [0 pref/0 metric] type ipv4
            via 1.1.1.2, Vlan4094
>B    10.255.4.1/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.4.2/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
>B    10.255.255.1/32 [200 pref/0 MED] updated 01:04:37 ago
         via 10.1.1.8 [0 pref/0 metric] type ipv4
            via 10.1.1.8, Ethernet1
>B    10.255.255.2/32 [200 pref/0 MED] updated 01:04:32 ago
         via 10.2.2.8 [0 pref/0 metric] type ipv4
            via 10.2.2.8, Ethernet2
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 01:06:54 ago
         via Null0, directly connected [NF]
>P    127.0.0.0/8 [1 pref/0 metric] updated 01:06:54 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 01:06:54 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 01:06:54 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 01:06:54 ago
```
...
Jericho2 Lpm:
  ...
  Route buckets used:  9  Rows used:     2   Entries Per Bucket:  6  Percent free:  99
...
Lpm Detail:
  Requests:  139  cleanses:  17  batches:  17  avg batch size:  8

Jericho Arp:
  ArpTable writes:      16859  queued      0   
  IngressTable writes:  75169  queued      0   
...
|0  |10.1.1.8/32       |ROUTE| Et1                |1007 |103421  | 74:83:ef:6c:be:a5 |  -  |288363|   -   
|0  |10.1.1.9/32       |TRAP | CoppSystemIpUcast  |0    |  -     | Receive           |  -  |524291|   -   
|0  |10.1.1.8/31       |TRAP | CoppSystemL3DstMiss|1007 |1007    | ArpTrap           |  -  |525301|   -   
|0  |10.2.2.8/32       |ROUTE| Et2                |1006 |103422  | 74:83:ef:6c:c1:3f |  -  |288365|   -   
...
|0  |10.255.255.1/32   |ROUTE| Et1                |1007 |103421  | 74:83:ef:6c:be:a5 |  -  |288364|   -   
|0  |10.255.255.2/32   |ROUTE| Et2                |1006 |103422  | 74:83:ef:6c:c1:3f |  -  |288368|   -   
...
|  -  |288363|ROUTE| Et1                |1007 |103421  | 74:83:ef:6c:be:a5 |   -   
|  -  |288364|ROUTE| Et1                |1007 |103421  | 74:83:ef:6c:be:a5 |   -   
|  -  |288365|ROUTE| Et2                |1006 |103422  | 74:83:ef:6c:c1:3f |   -   
|  -  |288368|ROUTE| Et2                |1006 |103422  | 74:83:ef:6c:c1:3f |   -   
