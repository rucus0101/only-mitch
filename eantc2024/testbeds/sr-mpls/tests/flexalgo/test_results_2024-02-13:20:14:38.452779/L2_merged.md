...
BGP neighbor is 1.1.1.1, remote AS 65301, internal link
  ...
  Last read 00:00:02, last write 00:00:29
  ...
  Last sent socket-error:Connect (Network is unreachable), Last time 01:04:55, First time 01:06:41, Repeats 6
...
BGP neighbor is 10.1.1.10, remote AS 65001, external link
  ...
  Last read 00:00:10, last write 00:00:43
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:04:39
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was Established
  Types of communities advertised: standard extended
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 9.3ms/2.5ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 78.51 Mbps
...
BGP neighbor is 10.2.2.10, remote AS 65001, external link
  ...
  Inherits configuration from and member of peer-group SPINES
  Last read 00:00:01, last write 00:00:39
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 01:04:34
  Number of transitions to established: 1
  Last state was OpenConfirm
  Last event was Established
  Types of communities advertised: standard extended
...
>C    10.1.1.10/31 [0 pref/0 metric] updated 01:04:42 ago
...
>C    10.255.3.2/32 [0 pref/0 metric] updated 01:06:57 ago
         via Loopback0, directly connected
>C    223.255.255.255/32 [0 pref/0 metric] updated 01:06:57 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>B    10.10.10.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.10.11.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
 B    10.10.12.0/24 [200 pref/0 MED] updated 01:04:50 ago
...
>B    10.10.13.0/24 [200 pref/0 MED] updated 01:04:33 ago
         ...
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.20.20.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.20.21.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
 B    10.20.22.0/24 [200 pref/0 MED] updated 01:04:50 ago
         via 1.1.1.1 [0 pref/0 metric] type ipv4
            via 1.1.1.1, Vlan4094
>B    10.20.23.0/24 [200 pref/0 MED] updated 01:04:33 ago
         ...
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.30.30.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.30.31.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
 B    10.30.32.0/24 [200 pref/0 MED] updated 01:04:50 ago
         via 1.1.1.1 [0 pref/0 metric] type ipv4
            via 1.1.1.1, Vlan4094
>B    10.30.33.0/24 [200 pref/0 MED] updated 01:04:33 ago
         ...
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.40.40.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.40.41.0/24 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
 B    10.40.42.0/24 [200 pref/0 MED] updated 01:04:50 ago
         via 1.1.1.1 [0 pref/0 metric] type ipv4
            via 1.1.1.1, Vlan4094
>B    10.40.43.0/24 [200 pref/0 MED] updated 01:04:33 ago
         ...
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.255.1.1/32 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.255.1.2/32 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.255.2.1/32 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.255.2.2/32 [200 pref/0 MED] updated 01:04:35 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.255.3.1/32 [200 pref/0 MED] updated 01:04:51 ago
         via 1.1.1.1 [0 pref/0 metric] type ipv4
            via 1.1.1.1, Vlan4094
...
>B    10.255.4.2/32 [200 pref/0 MED] updated 01:04:33 ago
         ...
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
>B    10.255.255.1/32 [200 pref/0 MED] updated 01:04:40 ago
         via 10.1.1.10 [0 pref/0 metric] type ipv4
            via 10.1.1.10, Ethernet1
>B    10.255.255.2/32 [200 pref/0 MED] updated 01:04:35 ago
         via 10.2.2.10 [0 pref/0 metric] type ipv4
            via 10.2.2.10, Ethernet2
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 01:06:55 ago
         via Null0, directly connected [NF]
>P    127.0.0.0/8 [1 pref/0 metric] updated 01:06:55 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 01:06:55 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 01:06:55 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 01:06:55 ago
```
...
Lpm Detail:
  Requests:  107  cleanses:  14  batches:  14  avg batch size:  7

Jericho Arp:
  ArpTable writes:      16869  queued      0   
  IngressTable writes:  75146  queued      0   
...
|0  |10.1.1.10/32      |ROUTE| Et1                |1007 |103421  | 74:83:ef:6c:be:a5 |  -  |288363|   -   
|0  |10.1.1.11/32      |TRAP | CoppSystemIpUcast  |0    |  -     | Receive           |  -  |524291|   -   
|0  |10.1.1.10/31      |TRAP | CoppSystemL3DstMiss|1007 |1007    | ArpTrap           |  -  |525301|   -   
|0  |10.2.2.10/32      |ROUTE| Et2                |1006 |103422  | 74:83:ef:6c:c1:3f |  -  |288365|   -   
