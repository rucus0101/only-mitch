...
Uptime: 3 hours and 52 minutes
Total memory: 32470188 kB
Free memory: 21210988 kB
...
path1:
  ...
  Inbound SPI: 0xc9735c:
    ...
    Lifetime current:
      Current bytes: 315920
      Current packets: 1140
  ...
  Outbound SPI: 0xca42a5:
    ...
    Lifetime current:
      Current bytes: 477467
      Current packets: 1192
...
path2:
  ...
  Inbound SPI: 0xc3bdd4:
    ...
    Lifetime config:
      ...
      Soft time limit: 2992 secs, Hard time limit: 3600 secs
    Lifetime current:
      Current bytes: 561672
      Current packets: 1674
  ...
  Outbound SPI: 0xcb221d:
    ...
    Lifetime current:
      Current bytes: 904691
      Current packets: 1654
      SA add time: Tue Mar 12 12:30:59 2024
      SA last use time: -
path3:
  ...
  SA state:
    SA type: ingress , SPI: 0xb1c39685
      ...
      Add time: Tue Mar 12 12:20:43 2024, Packets: 2301, Pair SPI: 0xb2e6deb
    SA type: egress , SPI: 0xb2e6deb
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 12:20:52 2024, Packets: 2467, Pair SPI: 0xb1c39685
  Inbound SPI: 0xb1c39685:
    ...
    Lifetime current:
      Current bytes: 339940
      Current packets: 2309
  ...
  Outbound SPI: 0xb2e6deb:
    ...
    Lifetime current:
      Current bytes: 828826
      Current packets: 2475
...
Traffic class 0: active (3:45:51)
MTU: 8914
...
Local interface: Ethernet1/7
Route state: IPsec established
Traffic class 0: active (3:46:40)
MTU: 8914
...
Local interface: Ethernet1/7
Route state: IPsec established
Traffic class 0: active (2:28:14)
MTU: 1414
...
BGP neighbor is 10.255.255.1, remote AS 65000, internal link
  ...
  Last read 00:00:47, last write 00:00:54
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 6.9ms/8.2ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 16.77 Mbps
...
BGP neighbor is 10.255.255.4, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group PATHFINDER
  Last read 00:00:34, last write 00:00:40
  Hold time is 180, keepalive interval is 60 seconds
  Configured hold time is 180, keepalive interval is 60 seconds
  Effective minimum hold time is 3 seconds
  Send failure hold time is 0 seconds
 ...
 Paths: 4 available
  Local
    :: from 10.255.255.4 (10.255.255.4)
      Origin IGP, metric -, localpref 100, weight 0, received 03:46:46 ago, valid, internal
...
Bgp routing table entry for ipv4Dps VTEP 10.255.255.8/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:49:56 ago, valid, local
      Tunnel encapsulation attribute: Dynamic path selection
...
Bgp routing table entry for ipv4Ipsec VTEP 10.255.255.8/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:50:02 ago, valid, local
      Tunnel encapsulation attribute: IP security
        Initial contact: false, Rekey counter: 0, Nonce length: 32
        DH group: 14, DH key length: 256
        Encryption algo: aes256, Authentication algo: sha256
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.255.255.8/32 [0 pref/0 metric] updated 03:50:44 ago
         via Loopback0, directly connected
>C    172.16.1.2/31 [0 pref/0 metric] updated 03:50:08 ago
         via Ethernet1/7, directly connected
>C    172.28.128.0/20 [0 pref/0 metric] updated 03:50:24 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>S    10.80.0.0/12 [1 pref/0 metric] updated 03:50:24 ago
         via 172.28.128.1 [0 pref/0 metric] type ipv4
            via 172.28.128.1, Management1/1
>S    10.224.0.0/12 [1 pref/0 metric] updated 03:50:24 ago
         via 172.28.128.1 [0 pref/0 metric] type ipv4
            via 172.28.128.1, Management1/1
>S    10.240.0.0/12 [1 pref/0 metric] updated 03:50:24 ago
         via 172.28.128.1 [0 pref/0 metric] type ipv4
            via 172.28.128.1, Management1/1
>S    172.16.0.0/12 [1 pref/0 metric] updated 03:50:24 ago
         via 172.28.128.1 [0 pref/0 metric] type ipv4
            via 172.28.128.1, Management1/1
>S    172.16.1.0/24 [1 pref/0 metric] updated 03:50:02 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 03:50:41 ago
         via Null0, directly connected [NF]
>P    10.255.255.1/32 [1 pref/0 metric] updated 03:50:03 ago
         via 10.255.255.1, Dps1
>P    10.255.255.4/32 [1 pref/0 metric] updated 03:50:03 ago
         via 10.255.255.4, Dps1
>P    10.255.255.10/32 [1 pref/0 metric] updated 02:28:25 ago
         via 10.255.255.10, Dps1
>P    127.0.0.0/8 [1 pref/0 metric] updated 03:50:41 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 03:50:06 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 03:50:06 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 03:50:06 ago
```
