...
path3:
  ...
  State: established
  Uptime: 3 hours, 41 minutes, 3 seconds
  VRF: default
  Type: static
  ...
  Inbound SPI: 0xca36e1:
    ...
    Lifetime current:
      Current bytes: 933108
      Current packets: 6265
      SA add time: Tue Mar 12 19:24:25 2024
      SA last use time: Tue Mar 12 20:08:44 2024
  Outbound SPI: 0xc140b5:
    ...
    Lifetime current:
      Current bytes: 1935928
      Current packets: 12970
      SA add time: Tue Mar 12 19:24:25 2024
      SA last use time: Tue Mar 12 20:08:44 2024
path4:
  ...
  Outbound SPI: 0xc76786:
    ...
    Lifetime current:
      Current bytes: 1923776
      Current packets: 12572
      SA add time: Tue Mar 12 19:25:54 2024
      SA last use time: Tue Mar 12 20:08:44 2024
path5:
  ...
  SA state:
    SA type: egress , SPI: 0x171f1258
      ...
      Add time: Tue Mar 12 19:27:38 2024, Packets: 11014, Pair SPI: 0x6bd58c54
    SA type: ingress , SPI: 0x6bd58c54
      Role: initiator, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:27:29 2024, Packets: 5151, Pair SPI: 0x171f1258
  Inbound SPI: 0x6bd58c54:
    ...
    Lifetime current:
      Current bytes: 785908
      Current packets: 5157
      SA add time: Tue Mar 12 19:27:29 2024
      SA last use time: Tue Mar 12 20:08:45 2024
  Outbound SPI: 0x171f1258:
    ...
    Lifetime current:
      Current bytes: 1861874
      Current packets: 11026
...
path6:
  ...
  SA state:
    SA type: egress , SPI: 0x46894230
      Role: initiator, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 20:03:54 2024, Packets: 1286, Pair SPI: 0x30bbf3ca
    SA type: ingress , SPI: 0x30bbf3ca
      Role: initiator, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 20:03:45 2024, Packets: 586, Pair SPI: 0x46894230
  ...
  Outbound SPI: 0x46894230:
    ...
    Lifetime current:
      Current bytes: 208794
      Current packets: 1298
...
path7:
  ...
  SA state:
    SA type: ingress , SPI: 0x77289e1b
      Role: initiator, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:24:59 2024, Packets: 5346, Pair SPI: 0x394fe354
    SA type: egress , SPI: 0x394fe354
      Role: initiator, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:25:07 2024, Packets: 11450, Pair SPI: 0x77289e1b
  Inbound SPI: 0x77289e1b:
    ...
    Lifetime current:
      Current bytes: 782208
      Current packets: 5352
  ...
  Outbound SPI: 0x394fe354:
    ...
    Lifetime current:
      Current bytes: 1872934
      Current packets: 11462
...
```text
Current System Time: Tue Mar 12 20:08:49 2024
...
```text
Current System Time: Tue Mar 12 20:08:50 2024
```
...
Traffic class 0: active (3:40:53)
MTU: 1414
...
Local interface: Ethernet1
Route state: IPsec established
Traffic class 0: active (3:40:46)
MTU: 1414
...
Local interface: Ethernet1
Route state: IPsec established
Traffic class 0: active (3:36:19)
MTU: 1414
...
BGP neighbor is 10.255.255.1, remote AS 65000, internal link
  ...
  Last read 00:00:41, last write 00:00:45
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 5.9ms/5.5ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 18.34 Mbps
...
BGP neighbor is 10.255.255.4, remote AS 65000, internal link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 03:40:57
...
Bgp routing table entry for ipv4Dps VTEP 10.255.255.11/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:41:10 ago, valid, local
      Tunnel encapsulation attribute: Dynamic path selection
...
Bgp routing table entry for ipv4Ipsec VTEP 10.255.255.11/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:51:38 ago, valid, local
      Tunnel encapsulation attribute: IP security
        Initial contact: false, Rekey counter: 0, Nonce length: 32
        DH group: 14, DH key length: 256
        Encryption algo: aes256, Authentication algo: sha256
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.255.255.11/32 [0 pref/0 metric] updated 04:15:03 ago
         via Loopback0, directly connected
>C    172.16.0.8/31 [0 pref/0 metric] updated 04:14:52 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>S    0.0.0.0/0 [1 pref/0 metric] updated 04:14:52 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 04:15:03 ago
         via Null0, directly connected [NF]
>P    10.255.255.1/32 [1 pref/0 metric] updated 03:41:10 ago
         via 10.255.255.1, Dps1
>P    10.255.255.4/32 [1 pref/0 metric] updated 03:41:10 ago
         via 10.255.255.4, Dps1
>P    10.255.255.5/32 [1 pref/0 metric] updated 03:40:59 ago
         via 10.255.255.5, Dps1
>P    10.255.255.6/32 [1 pref/0 metric] updated 03:40:59 ago
         via 10.255.255.6, Dps1
>P    10.255.255.12/32 [1 pref/0 metric] updated 03:36:33 ago
         via 10.255.255.12, Dps1
>P    127.0.0.0/8 [1 pref/0 metric] updated 04:15:03 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 03:51:43 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 03:51:43 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 03:51:43 ago
```
