...
Uptime: 4 hours and 17 minutes
Total memory: 16264236 kB
Free memory: 12883208 kB
...
path1:
  ...
  Inbound SPI: 0xcd39f2:
    ...
    Lifetime current:
      Current bytes: 413280
      Current packets: 2796
      SA add time: Tue Mar 12 19:22:34 2024
      SA last use time: Tue Mar 12 19:40:29 2024
  Outbound SPI: 0xcb69af:
    ...
    Lifetime current:
      Current bytes: 865252
      Current packets: 5730
      SA add time: Tue Mar 12 19:22:34 2024
      SA last use time: Tue Mar 12 19:40:29 2024
path2:
  ...
  Inbound SPI: 0xccc5af:
    ...
    Lifetime current:
      Current bytes: 370708
      Current packets: 2481
  ...
  Outbound SPI: 0xc860dc:
    ...
    Lifetime current:
      Current bytes: 858671
      Current packets: 5524
      SA add time: Tue Mar 12 19:23:20 2024
      SA last use time: Tue Mar 12 19:40:29 2024
path3:
  ...
  SA state:
    SA type: egress , SPI: 0xb1c39685
      ...
      Add time: Tue Mar 12 19:24:15 2024, Packets: 4474, Pair SPI: 0xb2e6deb
    SA type: ingress , SPI: 0xb2e6deb
      Role: initiator, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:24:14 2024, Packets: 2067, Pair SPI: 0xb1c39685
  Inbound SPI: 0xb2e6deb:
    ...
    Lifetime current:
      Current bytes: 314436
      Current packets: 2073
  ...
  Outbound SPI: 0xb1c39685:
    ...
    Lifetime current:
      Current bytes: 816314
      Current packets: 4486
...
```text
Current System Time: Tue Mar 12 19:40:50 2024
...
```text
Current System Time: Tue Mar 12 19:40:51 2024
```
...
Traffic class 0: active (2:26:12)
MTU: 1414
...
Local interface: Ethernet1
Route state: IPsec established
Traffic class 0: active (2:26:13)
MTU: 1414
...
Local interface: Ethernet1
Route state: IPsec established
Traffic class 0: active (2:26:09)
MTU: 1414
...
BGP neighbor is 10.255.255.1, remote AS 65000, internal link
  ...
  Last read 00:00:46, last write 00:00:35
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 8.0ms/7.8ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 13.63 Mbps
...
TCP Socket Information:
  ...
  Socket Statistics:
    ...
    Round-trip Time (rtt/rtvar): 3.0ms/1.7ms
    Delayed Ack Timeout (ato): 40.0ms
    Congestion Window (cwnd): 10
    TCP Throughput: 36.53 Mbps
...
Bgp routing table entry for ipv4Dps VTEP 10.255.255.10/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 02:26:34 ago, valid, local
      Tunnel encapsulation attribute: Dynamic path selection
...
Bgp routing table entry for ipv4Ipsec VTEP 10.255.255.6/32
 Paths: 4 available
  Local
    :: from 10.255.255.4 (10.255.255.4)
      Origin IGP, metric -, localpref 100, weight 0, received 02:05:12 ago, valid, internal
      Tunnel encapsulation attribute: IP security
...
Bgp routing table entry for ipv4Ipsec VTEP 10.255.255.10/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:49:02 ago, valid, local
      Tunnel encapsulation attribute: IP security
        Initial contact: false, Rekey counter: 0, Nonce length: 32
        DH group: 14, DH key length: 256
        Encryption algo: aes256, Authentication algo: sha256
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.255.255.10/32 [0 pref/0 metric] updated 04:16:48 ago
         via Loopback0, directly connected
>C    172.16.1.6/31 [0 pref/0 metric] updated 04:16:42 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>S    0.0.0.0/0 [1 pref/0 metric] updated 03:49:06 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 04:16:47 ago
         via Null0, directly connected [NF]
>P    10.255.255.1/32 [1 pref/0 metric] updated 02:26:34 ago
         via 10.255.255.1, Dps1
>P    10.255.255.4/32 [1 pref/0 metric] updated 02:26:34 ago
         via 10.255.255.4, Dps1
>P    10.255.255.8/32 [1 pref/0 metric] updated 02:26:27 ago
         via 10.255.255.8, Dps1
>P    127.0.0.0/8 [1 pref/0 metric] updated 04:16:47 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 03:49:05 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 03:49:05 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 03:49:05 ago
```
