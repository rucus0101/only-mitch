...
path3:
  ...
  Inbound SPI: 0xcc71b3:
    ...
    Lifetime current:
      ...
      SA last use time: Tue Mar 12 19:58:40 2024
...
path4:
  ...
  Inbound SPI: 0xc9f913:
    ...
    Lifetime current:
      Current bytes: 787436
      Current packets: 5271
  ...
  Outbound SPI: 0xc2810a:
    ...
    Lifetime current:
      Current bytes: 3111533
      Current packets: 11238
      SA add time: Tue Mar 12 19:26:42 2024
      SA last use time: Tue Mar 12 19:58:40 2024
path5:
  Source address: 172.16.0.11, Destination address: 172.16.0.1
  State: established
  Uptime: 3 hours, 34 minutes, 31 seconds
  VRF: default
  Type: dynamic
  Remote IP: 10.255.255.5
  Role: responder
  ...
  SA state:
    SA type: egress , SPI: 0x6ea1c293
      ...
      Add time: Tue Mar 12 19:24:52 2024, Packets: 10886, Pair SPI: 0x82dc9fc6
    SA type: ingress , SPI: 0x82dc9fc6
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:24:51 2024, Packets: 5103, Pair SPI: 0x6ea1c293
  Inbound SPI: 0x82dc9fc6:
    ...
    Lifetime current:
      Current bytes: 732324
      Current packets: 5109
  ...
  Outbound SPI: 0x6ea1c293:
    ...
    Lifetime current:
      Current bytes: 3485182
      Current packets: 10898
...
path6:
  ...
  Role: responder
  Packets in: 21164, Packets out: 45126
  Last known rekey count: 0
  Dynamic state: established
  Last established time: Tue Mar 12 19:26:50 2024
  DH crypto:
  ...
  SA state:
    SA type: ingress , SPI: 0x394fe354
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:25:00 2024, Packets: 5097, Pair SPI: 0x77289e1b
    SA type: egress , SPI: 0x77289e1b
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:25:01 2024, Packets: 10868, Pair SPI: 0x394fe354
  Inbound SPI: 0x394fe354:
    ...
    Lifetime current:
      Current bytes: 731612
      Current packets: 5103
  ...
  Outbound SPI: 0x77289e1b:
    ...
    Lifetime current:
      Current bytes: 1684752
      Current packets: 10880
      SA add time: Tue Mar 12 19:25:01 2024
      SA last use time: Tue Mar 12 19:58:40 2024
path7:
  ...
  SA state:
    SA type: ingress , SPI: 0x9cfb203a
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:28:43 2024, Packets: 4640, Pair SPI: 0xa6fce5af
    SA type: egress , SPI: 0xa6fce5af
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:28:51 2024, Packets: 9836, Pair SPI: 0x9cfb203a
  Inbound SPI: 0x9cfb203a:
    ...
    Lifetime current:
      Current bytes: 679272
      Current packets: 4646
  ...
  Outbound SPI: 0xa6fce5af:
    ...
    Lifetime current:
      Current bytes: 3058044
      Current packets: 9848
...
```text
Current System Time: Tue Mar 12 20:06:47 2024
...
Traffic class 0: active (3:29:17)
MTU: 8914
...
Local interface: Ethernet1
Route state: IPsec established
Traffic class 0: active (3:27:38)
MTU: 8914
...
BGP neighbor is 10.255.255.4, remote AS 65000, internal link
  ...
  Connect timer is inactive
  Idle-restart timer is inactive
  BGP state is Established, up for 03:34:35
...
Bgp routing table entry for ipv4Dps VTEP 10.255.255.12/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:36:22 ago, valid, local
      Tunnel encapsulation attribute: Dynamic path selection
...
Bgp routing table entry for ipv4Ipsec VTEP 10.255.255.12/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 03:49:30 ago, valid, local
      Tunnel encapsulation attribute: IP security
        Initial contact: false, Rekey counter: 0, Nonce length: 32
        DH group: 14, DH key length: 256
        Encryption algo: aes256, Authentication algo: sha256
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.255.255.12/32 [0 pref/0 metric] updated 04:13:15 ago
         via Loopback0, directly connected
>C    172.16.0.10/31 [0 pref/0 metric] updated 04:13:05 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>S    0.0.0.0/0 [1 pref/0 metric] updated 03:49:36 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 04:13:14 ago
         via Null0, directly connected [NF]
>P    10.255.255.1/32 [1 pref/0 metric] updated 03:36:23 ago
         via 10.255.255.1, Dps1
>P    10.255.255.4/32 [1 pref/0 metric] updated 03:36:23 ago
         via 10.255.255.4, Dps1
>P    10.255.255.5/32 [1 pref/0 metric] updated 03:34:36 ago
         via 10.255.255.5, Dps1
>P    10.255.255.6/32 [1 pref/0 metric] updated 03:34:36 ago
         via 10.255.255.6, Dps1
>P    10.255.255.11/32 [1 pref/0 metric] updated 03:34:36 ago
         via 10.255.255.11, Dps1
>P    127.0.0.0/8 [1 pref/0 metric] updated 04:13:14 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 03:49:35 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 03:49:35 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 03:49:35 ago
```
