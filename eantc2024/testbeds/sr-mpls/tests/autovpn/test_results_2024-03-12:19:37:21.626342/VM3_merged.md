...
path4:
  ...
  State: established
  Uptime: 1 hour, 38 minutes, 38 seconds
  VRF: default
  Type: static
  Remote IP: 10.255.255.7
  Role: responder
  Inbound SPI: 0xc228a4:
    ...
    Lifetime current:
      Current bytes: 300080
      Current packets: 2068
      SA add time: Tue Mar 12 19:26:46 2024
      SA last use time: Tue Mar 12 19:40:53 2024
  Outbound SPI: 0xc35f92:
    ...
    Lifetime current:
      Current bytes: 656306
      Current packets: 4510
      SA add time: Tue Mar 12 19:26:46 2024
      SA last use time: Tue Mar 12 19:40:53 2024
path5:
  Source address: 172.16.2.7, Destination address: 172.16.2.2
  State: established
  Uptime: 1 hour, 36 minutes, 33 seconds
  VRF: default
  Type: dynamic
  Remote IP: 10.255.255.7
  Role: responder
  ...
  SA state:
    SA type: egress , SPI: 0x47c105f6
      ...
      Add time: Tue Mar 12 19:31:52 2024, Packets: 2400, Pair SPI: 0x5f53934e
    SA type: ingress , SPI: 0x5f53934e
      Role: responder, SA rekey state: initial, Peer nonce type: init
      Add time: Tue Mar 12 19:31:43 2024, Packets: 1119, Pair SPI: 0x47c105f6
  Inbound SPI: 0x5f53934e:
    ...
    Lifetime current:
      Current bytes: 166356
      Current packets: 1121
      SA add time: Tue Mar 12 19:31:43 2024
      SA last use time: Tue Mar 12 19:40:52 2024
  Outbound SPI: 0x47c105f6:
    ...
    Lifetime current:
      Current bytes: 412500
      Current packets: 2404
...
Local interface: Ethernet1
Route state: IPsec established
Traffic class 0: active (1:36:29)
MTU: 1414
...
BGP neighbor is 10.255.255.2, remote AS 65000, internal link
  ...
  Failed connection attempts is 256
  Idle-restart timer is inactive
  BGP state is Connect
  Number of transitions to established: 0
  Last state was Active
  Last event was ConnectRetry
  Last sent socket-error:Connect (Network is unreachable), Last time 01:41:52
...
BGP neighbor is 10.255.255.3, remote AS 65000, internal link
  ...
  Inherits configuration from and member of peer-group PATHFINDER
  Last read 00:00:46, last write 00:00:22
...
Bgp routing table entry for ipv4Dps VTEP 10.255.255.9/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 01:38:45 ago, valid, local
      Tunnel encapsulation attribute: Dynamic path selection
...
Bgp routing table entry for ipv4Ipsec VTEP 10.255.255.9/32
 Paths: 1 available
  Local
    - from - (0.0.0.0)
      Origin IGP, metric -, localpref -, weight 0, received 01:41:45 ago, valid, local
      Tunnel encapsulation attribute: IP security
        Initial contact: false, Rekey counter: 0, Nonce length: 32
        DH group: 14, DH key length: 256
        Encryption algo: aes256, Authentication algo: sha256
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       NF - Not in FEC
>C    10.255.255.9/32 [0 pref/0 metric] updated 01:42:00 ago
         via Loopback0, directly connected
>C    172.16.2.6/31 [0 pref/0 metric] updated 01:41:51 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>S    0.0.0.0/0 [1 pref/0 metric] updated 01:41:51 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    0.0.0.0/8 [1 pref/0 metric] updated 01:41:59 ago
         via Null0, directly connected [NF]
>P    10.255.255.2/32 [1 pref/0 metric] updated 01:41:46 ago
         via 10.255.255.2, Dps1
>P    10.255.255.3/32 [1 pref/0 metric] updated 01:41:46 ago
         via 10.255.255.3, Dps1
>P    10.255.255.7/32 [1 pref/0 metric] updated 01:36:37 ago
         via 10.255.255.7, Dps1
>P    127.0.0.0/8 [1 pref/0 metric] updated 01:41:59 ago
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 01:41:49 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 01:41:49 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 01:41:49 ago
```
