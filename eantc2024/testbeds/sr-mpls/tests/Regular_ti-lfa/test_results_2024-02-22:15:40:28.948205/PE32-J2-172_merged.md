...
IGP       default  Ribbon-32        L2   Ethernet50/1       P2P               UP    68          00                  
IGP       default  Ericsson_47      L2   Ethernet51/1       P2P               UP    24          02                  
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    Ribbon-32.00-00              30   9776   724     79 L2  0000.0000.0032.00-00  <>
      NLPID: 0xCC(IPv4)
    ...
    Ribbon-32.00-03              19  28099   835     38 L2  0000.0000.0032.00-03  <>
      Hostname: Ribbon-32
    Ribbon-32.00-04             243   5621  1123    285 L2  0000.0000.0032.00-04  <>
    ...
    PE32-J2-172.00-00            56  23686  1111    351 L2  0100.0000.0172.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 811 s
      NLPID: 0xCC(IPv4)
...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    LSPID                   Seq Num  Cksum  Life Length IS  Received LSPID        Flags
    h3c_24_S12500R-48C6D.00-00      7845  47415  1074    461 L2  0000.0000.0024.00-00  <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: h3c_24_S12500R-48C6D
    ...
    Ericsson_47.00-00            58  38900   964    325 L2  0000.0000.0047.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.47 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    PE31-J2-171.00-00           543   7964   421    275 L2  0100.0000.0171.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4)
      Hostname: PE31-J2-171
      Area addresses: 49.0000
    ...
    PE32-J2-172.00-00            56  23686  1110    351 L2  0100.0000.0172.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 810 s
      NLPID: 0xCC(IPv4)
      Hostname: PE32-J2-172
      Area addresses: 49.0000
      Interface address: 20.47.172.172
...
BGP neighbor is 10.0.0.211, remote AS 65000, internal link
  ...
  Last sent socket-error:Connect (Network is unreachable), Last time 00:00:49, First time 1d00h, Repeats 515
...
BGP neighbor is 10.0.1.49, remote AS 65000, internal link
  ...
  Hold timer is inactive
  Keepalive timer is inactive
  Connect timer is active, time left: 00:03:07
  Connection interval is 148 seconds
  ...
  Last state was Connect
  Last event was TransportError
  Last sent socket-error:Connect (Network is unreachable), Last time 00:00:02, First time 00:25:37, Repeats 9
  Types of communities advertised: standard extended large
  Neighbor Capabilities:
  Restart timer is inactive
  End of rib timer is inactive
...
Codes: C - Connected, S - Static, P - Route Input, G - Gribi
       ...
       A - Next hop not resolved in ARP/ND
       NF - Not in FEC
>P    ::/96 [1 pref/0 metric] updated 01:41:20 ago
         via Null0, directly connected [NF]
>P    ::ffff:127.0.0.0/104 [1 pref/0 metric] updated 01:41:20 ago
         via :: [1 pref/1 metric] type ipv6
            via , directly connected
>P    fe80::/10 [1 pref/0 metric] updated 01:41:20 ago
```
